 ...
 *
 * Encapsulates the multi-step customer registration wizard (/register):
 *  - Step 1: State dropdown selection & Terms checkbox
 *  - Step 2: Customer Email entry
 *  - Step 3: Account Password creation
 *  - Validation: Duplicate email prevention alert (AQ-07)
 */
export class RegistrationPage {
  ...
  async captureRegistrationSnapshot(visualConfig: ApplitoolsVisualConfig = REGISTRATION_FIGMA_CONFIG, tag = 'Registration page loaded'): Promise<void> {
