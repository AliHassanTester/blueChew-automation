...
import { LOGIN_INITIAL_FIGMA_CONFIGS } from '@data/tier2-visual/figma.visual.data';
 ...
 */
test.describe('Tier 2: Applitools MCP Native Integration Demo @tier2 @visual @demo', () => {
