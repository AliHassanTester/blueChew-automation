...
import { getFooterRedirectsData } from '@data/tier2-visual/footer-redirects.data';
...
test.describe('Tier 2: Homepage Footer - Bottom Page Redirects & Visual Baseline @tier2 @visual @footer', () => {
  test(
