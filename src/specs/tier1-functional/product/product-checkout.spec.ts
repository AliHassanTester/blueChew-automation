...
import { getProductCheckoutData } from '@data/tier1-functional/product/product-checkout.data';
import { test } from '@fixtures/page.fixtures';
import { GOLD_TRANSITION_FIGMA_CONFIG } from '@data/tier2-visual/figma.visual.data';

// ── 1. Standard Product Checkout Flows ───────────────────────────────────────
test.describe('Tier 1: Unified Product Checkout Flows @tier1 @product', () => {
  const products = [
...
test(
  ...
  { tag: ['@gold-medical', '@tier1', '@product', '@visual'] },
