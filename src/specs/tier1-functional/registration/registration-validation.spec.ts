...
import { getRegistrationValidationData } from '@data/tier1-functional/registration/registration-validation.data';
import { test } from '@fixtures/page.fixtures';

const scenario = getRegistrationValidationData('AQ-07-Register-Duplicate-Email');

test.describe('Tier 1: Registration Validation Flow @tier1 @registration @smoke', () => {
  test(
    `
