...
import { getRegistrationData } from '@data/tier1-functional/login/signup-to-approved-order.data';
import { test } from '@fixtures/page.fixtures';

const scenario = getRegistrationData('AQ-01-Sign-up-To-Approved-Order-E2E');

test.describe('Tier 1: Sign-up to Approved Order E2E Journey @tier1 @e2e @smoke', () => {
  test(
    `
