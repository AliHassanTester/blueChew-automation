...
description: use this skill when creating, updating, reviewing, validating, or auditing Playwright TypeScript automation tests. Trigger for requests involving new test generation, Page Object Model files, locators, fixtures, test data, specs, Allure reporting, environment handling, or framework compliance.
---

# Playwright Automation Framework

Use this as the routing file for this Playwright automation framework. Keep this file small. Load only the workflow or reference file needed for the current task.
...
- For generating automation from a **Jam recording** of a user flow, read `workflows/record-and-automate.md`.
- For exploring the live application before writing a new test, read `workflows/explore-and-implement.md`.
...
For agent execution behavior, read `agents/playwright-agent.md`.
