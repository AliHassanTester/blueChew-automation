...
- Name: e2e\login.spec.ts >> Login — Functional >> login page renders email input, password input, and submit button
- Location: automation\tests\e2e\login.spec.ts:19:8
